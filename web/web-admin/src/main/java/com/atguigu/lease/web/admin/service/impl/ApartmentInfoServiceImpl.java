...
public class ApartmentInfoServiceImpl extends ServiceImpl<ApartmentInfoMapper, ApartmentInfo>
    ...
    public void saveOrUpdateApartment(ApartmentSubmitVo apartmentSubmitVo) {
        ...
        if (isUpdate) {
            ...
            //3.删除标签列表
            LambdaQueryWrapper<ApartmentLabel> lambdaQueryWrapper = new LambdaQueryWrapper<ApartmentLabel>();
            ...
            //4.删除杂费列表
            LambdaQueryWrapper<ApartmentFeeValue> feeValueQueryWrapper = new LambdaQueryWrapper<ApartmentFeeValue>();
